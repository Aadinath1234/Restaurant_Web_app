                        ...
                        <div className='grid grid-cols-1  sm:grid-cols-2 gap-6'>
                            ...
                            <div className='flex flex-col justify-center gap-6 sm:pt-0 '>
                                ...
                                <p className='text-sm text-gray-500 tracking-wide leading-5'>
                                 Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sed optio at accusamus ducimus numquam nisi rerum suscipit molestias corrupti Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus aliquid voluptate distinctio expedita voluptatum quis praesentium illo eaque reiciendis. Eum!
                                </p>
