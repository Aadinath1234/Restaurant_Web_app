    ...
    return (
        <>
            <div
               ...
               sm:min-h-[600px] bg-gray-100 dark:bg-gray-950 dark:text-white duration-200 flex justify-center items-center
              " >
                <div className="container pd-8 sm:pb-0">
                    <div className="grid grid-cols-1 sm:grid-cols-2">
                        ...
                        className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1">
                            ...
                            <p className="text-sm">
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur libero enim, voluptate quibusdam corporis nihil alias animi voluptatum labore possimus.
